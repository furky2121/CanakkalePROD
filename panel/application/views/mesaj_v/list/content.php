                        ...
                        <?php foreach($items as $item) { ?>
                            ...
                            <tr>
                                ...
                                <td  class="text-center w100">
                                    <input
                                        data-url="<?php echo base_url("mesaj/isActiveSetter/$item->id"); ?>"
                                        class="isActive"
                                        type="checkbox"
                                        data-switchery
                                        data-color="#10c469"
                                ...
                                <td class="text-center w150">
                                    <button
                                        data-url="<?php echo base_url("mesaj/delete/$item->id"); ?>"
                                        class="btn btn-sm btn-danger btn-outline remove-btn">
                                        <i class="fa fa-trash"></i> Sil
                                    </button>
                                    <a href="<?php echo base_url("mesaj/update_form/$item->id"); ?>" class="btn btn-sm btn-info btn-outline"><i class="fa fa-desktop"></i> Mesajı Gör</a>
                                </td>
                            </tr>
