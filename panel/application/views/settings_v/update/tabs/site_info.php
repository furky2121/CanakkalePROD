<div role="tabpanel" class="tab-pane in active fade" id="tab-1">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-8">
            <label>Preloader Yazısı</label>
            <input class="form-control" placeholder="Preloader Yazısı"
                   name="loaderyazi"
                   value="<?php echo isset($form_error) ? set_value("loaderyazi") : $item->loaderyazi; ?>">
            <?php if (isset($form_error)) { ?>
                <small
                        class="pull-right input-form-error"> <?php echo form_error("loaderyazi"); ?></small>
            <?php } ?>
        </div>
