        ...
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("slides/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group  mo ma">
                        <label>Alt Başlık</label>
                        <input class="form-control" placeholder="Alt Başlık" name="altbaslik" value="<?php echo $item->altbaslik; ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 image_upload_container">
                            <img src="<?php echo get_picture($viewFolder, $item->img_url,"1920x1080"); ?>" alt="" class="img-responsive">
                        </div>
                    ...
                    <div class="button-information-container" style="display : <?php echo ($item->allowButton) ? "block" : "none"; ?>">
                        ...
                        <hr>
                        <div class="form-group">
                            <label>Buton Başlık (2)</label>
                            <input class="form-control" placeholder="Butonun üzerindeki yazı 2" name="yenibutonisim" value="<?php echo $item->yenibutonisim; ?>">
                            <?php if(isset($form_error)){ ?>
                                <small class="pull-right input-form-error"> <?php echo form_error("yenibutonisim"); ?></small>
                            <?php } ?>
                        </div>
                        <div class="form-group">
                            <label>URL Bilgisi (2)</label>
                            <input class="form-control" placeholder="Butona basıldığında gidilecek olan URL Bilgisi 2" name="yenibutonlink" value="<?php echo $item->yenibutonlink; ?>">
                            <?php if(isset($form_error)){ ?>
                                <small class="pull-right input-form-error"> <?php echo form_error("yenibutonlink"); ?></small>
                            <?php } ?>
                        </div>
                    </div>
