    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("yorum/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>İsim Soyisim</label>
                        <input class="form-control" placeholder="İsim Soyisim" name="title" value="<?php echo $item->title; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Pozisyon" name="statu" value="<?php echo $item->statu; ?>">
                        <?php if(isset($form_error)){ ?>
