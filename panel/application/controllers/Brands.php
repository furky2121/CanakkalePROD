...
class Brands extends CI_Controller
{
    ...
    public function save(){
        ...
        if($validate){
            ...
            $image_360x220 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",360,220, $file_name);
            ...
            if($image_360x220){
                ...
                $insert = $this->brand_model->add(
                    array(
                        ...
                        "butonismi"         => $this->input->post("butonismi"),
                        "butonlinki"         => $this->input->post("butonlinki"),
                        "img_url"       => $file_name,
                        "rank"          => 0,
                        "isActive"      => 1,
